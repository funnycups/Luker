...
::: tip 第一次用 Studio?
看[从零写一个 CardApp](/zh-CN/features/card-editor/walkthrough)，用一个轻小说西式异世界冒险题材的角色卡演示完整工作循环，含提示词实践小抄。本页是 Studio 的能力清单，walkthrough 是从零跑通的实战路径。
:::
