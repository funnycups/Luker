...
| [维多利亚案宗](/zh-CN/features/card-editor/walkthrough/victorian) | 1888 伦敦福尔摩斯式侦探卡 | 记忆图派生 schema + orchestrator loop（draft → critique → revise）+ 卡专用世界书 + 变量驱动 CardApp 面板 | 想看 schema / loop / 变量驱动 UI 全栈协同 |
