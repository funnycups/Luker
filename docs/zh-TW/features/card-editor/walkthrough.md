...
![成品截圖](/images/cardapp-studio-walkthrough/step-08-end-to-end.png)
...
![Studio 初始空狀態](/images/cardapp-studio-walkthrough/step-02-studio-empty.png)
...
![輸入第一輪 prompt](/images/cardapp-studio-walkthrough/step-03-first-prompt.png)
...
![AI 工作過程:工具呼叫 + diff 審批](/images/cardapp-studio-walkthrough/step-04-first-round-work.png)
...
![第一輪跑起來的樣子](/images/cardapp-studio-walkthrough/step-05-first-round-running.png)
...
![完整對話 + 狀態變化](/images/cardapp-studio-walkthrough/step-08-end-to-end.png)
...
![訊息上方插畫](/images/cardapp-studio-walkthrough/step-09-scene-image.png)

![「畫下所見」按鈕觸發](/images/cardapp-studio-walkthrough/step-10-redraw-button.png)
