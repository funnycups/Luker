...
export const event_types = {
    ...
    GENERATION_BEFORE_WORLD_INFO_SCAN: 'generation_before_world_info_scan',
    GENERATION_AFTER_WORLD_INFO_SCAN: 'generation_after_world_info_scan',
    GENERATION_WORLD_INFO_FINALIZED: 'generation_world_info_finalized',
    GENERATION_BEFORE_API_REQUEST: 'generation_before_api_request',
    ...
    ORCH_PRESET_DELETED: 'orch_preset_deleted',
    ORCH_PRESET_EXPORT_READY: 'orch_preset_export_ready',
    ORCH_PRESET_IMPORT_READY: 'orch_preset_import_ready',
    ...
    CHAT_WRITE_CONFLICT: 'chat_write_conflict',
};
