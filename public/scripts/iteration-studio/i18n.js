...
const ZH_CN_DATA = {
    ...
    'Clear all session history for this scope?': '清空当前作用域的全部会话历史？',
    'Apply': '应用',
    ...
    '(None)': '（无）',
    'Pending changes': '待应用的修改',
    'Close': '关闭',
    'Delete': '删除',
    'Delete this saved session?': '删除这个已保存的会话?',
    'AI iteration is running...': 'AI 迭代进行中…',
    'AI suggested changes are waiting for approval.': 'AI 提出的修改等待你审核。',
    ...
    'Iteration failed: ${0}': '迭代失败：${0}',
    'Iteration Studio session format updated; previous sessions cleared.': '迭代工作台会话格式已更新，旧会话已清除。',
...
const ZH_TW_DATA = {
    ...
    'Clear all session history for this scope?': '清空當前作用域的全部會話歷史？',
    'Apply': '應用',
    'Apply to Global': '套用到全域',
    'Apply to Character': '套用到角色卡',
    'New session': '新建會話',
    'No saved sessions': '沒有已保存的會話',
    '(None)': '（無）',
    'Pending changes': '待應用的修改',
    'Close': '關閉',
    'Delete': '刪除',
    'Delete this saved session?': '刪除這個已儲存的會話?',
    'AI iteration is running...': 'AI 迭代進行中…',
    'AI suggested changes are waiting for approval.': 'AI 提出的修改等待你審核。',
    'AI iteration updated.': 'AI 迭代已更新。',
    ...
    'Iteration failed: ${0}': '迭代失敗：${0}',
    'Iteration Studio session format updated; previous sessions cleared.': '迭代工作台會話格式已更新，舊會話已清除。',
