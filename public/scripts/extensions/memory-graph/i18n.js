...
export function registerLocaleData() {
    addLocaleData('zh-cn', {
        ...
        'Query rewrite API preset (Connection profile)': '查询改写 API 预设（连接配置）',
    ...
    addLocaleData('zh-tw', {
        ...
        'Query rewrite API preset (Connection profile)': '查詢改寫 API 預設（連線設定）',
        ...
        'Iteration AI API preset (Connection profile)': '迭代 AI 的 API 預設（連線配置）',
