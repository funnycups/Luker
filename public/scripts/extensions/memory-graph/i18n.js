...
export function registerLocaleData() {
    addLocaleData('zh-cn', {
        ...
        'Memory graph persist failed [op=${0} stage=${1} seq=${2} floor=${3} chatLen=${4}]: ${5}': '记忆图持久化失败 [op=${0} stage=${1} seq=${2} 楼层=${3} 聊天长度=${4}]: ${5}',
    ...
    addLocaleData('zh-tw', {
        ...
        'Memory graph persist failed [op=${0} stage=${1} seq=${2} floor=${3} chatLen=${4}]: ${5}': '記憶圖持久化失敗 [op=${0} stage=${1} seq=${2} 樓層=${3} 聊天長度=${4}]: ${5}',
