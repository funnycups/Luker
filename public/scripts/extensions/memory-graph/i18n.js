...
export function registerLocaleData() {
    addLocaleData('zh-cn', {
        ...
        'Persistent injection max per type help body': '每类型只保留最新 K 个常驻注入到主上下文，更老的仍可通过召回捞回。0 = 不限制。',
    ...
    addLocaleData('zh-tw', {
        ...
        'Persistent injection max per type help body': '每類型只保留最新 K 個常駐注入到主上下文，更老的仍可透過召回撈回。0 = 不限制。',
