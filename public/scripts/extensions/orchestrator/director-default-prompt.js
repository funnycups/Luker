...
export function buildDirectorDefaultSystemPrompt(_unusedArgs = {}) {
    return [
        ...
        '',
        '   Await all before moving on. `chat_scout` and `memory_scout` annotate findings with signal levels — do not anchor downstream agents on items they marked low-signal / demoted. **Do NOT dispatch step-2 brainstormers in the same round as these scouts** — brainstormers need scout findings in their context, and same-round siblings cannot read each other\'s output.',
