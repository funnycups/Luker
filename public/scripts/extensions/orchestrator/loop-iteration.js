...
export const LOOP_ITERATION_CONTRACT_LINES = Object.freeze([
    ...
    '- Editable fields: system_prompt (string), apiPresetName (string), promptPresetName (string), max_rounds (1-50), wall_clock_budget_ms (>= 10000), tools.note.add, tools.chat.read_range, tools.chat.search, tools.lorebook.search, tools.lorebook.get, tools.memory.search, tools.memory.list_recent, tools.memory.get (all boolean).',
