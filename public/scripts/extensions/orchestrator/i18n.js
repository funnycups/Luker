...
export function registerLocaleData() {
    addLocaleData('zh-cn', {
        ...
        'Manage skills...': '管理技能…',
        'Skill manager failed: ${0}': '技能管理器打开失败：${0}',
        ...
        '(no tool calls — reasoning-only round)': '（无工具调用，纯推理轮次）',
        'No main-agent rounds recorded.': '尚未记录主代理轮次。',
        ...
        '${0} approved': '${0} 已批准',
        '${0} rejected': '${0} 已拒绝',
        'Commit ${0} lorebook decision(s)': '提交 ${0} 条世界书决定',
        'Clear ${0} rejected': '清除 ${0} 条已拒绝',
        ...
        'Skill Manager': '技能管理器',
        'Edit skill': '编辑技能',
        'Per-agent skill visibility. Use [+ inherit mode default] to combine.': '此 Agent 可见的技能。点击 [+ 继承模式默认] 与模式默认叠加。',
        'Per-node skill visibility. Use [+ inherit mode default] to combine.': '此节点可见的技能。点击 [+ 继承模式默认] 与模式默认叠加。',
        'Per-sub-agent skill visibility. Use [+ inherit mode default] to combine.': '此子代理可见的技能。点击 [+ 继承模式默认] 与模式默认叠加。',
        'Mode-level skills (baseline for every agent)': '模式级技能（所有 Agent 的基线）',
        'Mode-level skills (baseline for every node)': '模式级技能（所有节点的基线）',
        'Main agent skills': '主代理技能',
        'Planner skills': 'Planner 技能',
        'Skills visible to the loop agent.': 'Loop Agent 可见的技能。',
        'Skills visible to the main agent. + inherits mode default.': '主代理可见的技能。点击 + 继承模式默认。',
        'Skills visible to the planner. + inherits mode default.': 'Planner 可见的技能。点击 + 继承模式默认。',
        // Skill chips component
        '(inherit mode default)': '（继承模式默认）',
        '+ inherit mode default': '+ 继承模式默认',
        'Inherit mode default visible skills': '继承模式默认的可见技能',
        'Inherit mode default visible skills. Click x to remove.': '继承模式默认的可见技能。点击 x 移除。',
        ...
        'Skill is not installed in your current data dir.': '当前数据目录未安装此技能。',
        'All available skills already chipped': '所有可用技能均已添加',
        'Add a skill': '添加技能',
        'Add...': '添加……',
        'Add': '添加',
        // Skill manager panel — top-level shell
        'Installed': '已安装',
        'Browse bundled': '浏览随服务器分发的技能',
        'Filter by scope:': '按作用域筛选：',
        'All scopes': '全部作用域',
        'Import bundled': '导入随服务器分发的技能',
        ...
        'Move to...': '移动到……',
        'Rename': '重命名',
        '(no skills in this scope)': '（此作用域下没有技能）',
        'No skills installed. Use Import or Create to add some.': '当前没有已安装的技能。请使用「导入」或「新建」添加。',
        'Failed to load skills: ${0}': '加载技能失败：${0}',
        'Failed to render bundled browser: ${0}': '渲染分发列表失败：${0}',
        // Skill manager actions — toasts / confirms / prompts
        'Bundled import: ${0} installed, ${1} skipped.': '从分发列表导入：新装 ${0} 个，跳过 ${1} 个。',
        'Bundled import failed: ${0}': '从分发列表导入失败：${0}',
        'Failed to read file: ${0}': '读取文件失败：${0}',
        'Unsupported file: ${0}': '不支持的文件：${0}',
        'Import into scope': '导入到作用域',
        'Enter the URL of a skill zip bundle': '请输入技能 zip 包的链接',
        'Import': '导入',
        'URL import: ${0} installed, ${1} skipped.': '从链接导入：新装 ${0} 个，跳过 ${1} 个。',
        'URL import failed: ${0}': '从链接导入失败：${0}',
        'Failed to read skill: ${0}': '读取技能失败：${0}',
        'Delete skill "${0}" from ${1}? This cannot be undone.': '确认从 ${1} 删除技能「${0}」？此操作不可撤销。',
        'Deleted skill: ${0}': '已删除技能：${0}',
        'Delete failed: ${0}': '删除失败：${0}',
        'Rename skill "${0}" to:': '将技能「${0}」重命名为：',
        'A skill named "${0}" already exists in ${1}. Server will refuse the rename. Try a different name?': '${1} 中已存在名为「${0}」的技能，服务器会拒绝此次重命名。换一个名字？',
        'Retry': '重试',
        'Renamed: ${0} -> ${1}': '已重命名：${0} → ${1}',
        'Rename failed: ${0}': '重命名失败：${0}',
        'Move "${0}" to scope': '将「${0}」移动到作用域',
        'Skill already in that scope.': '技能已经在该作用域。',
        'A skill named "${0}" already exists in ${1}. Move will fail unless you delete the existing one first. Proceed anyway?': '${1} 中已存在名为「${0}」的技能，除非先删除现有技能，否则移动会失败。仍要继续吗？',
        'Proceed': '继续',
        'Moved ${0}: ${1} -> ${2}': '已移动 ${0}：${1} → ${2}',
        'Move failed: ${0}': '移动失败：${0}',
        'Preview failed: ${0}': '预览失败：${0}',
        'Skill "${0}" already exists in ${1} with different content. Replace it?': '${1} 中已存在名为「${0}」的技能且内容不同。是否替换？',
        'Replace': '替换',
        'Skip': '跳过',
        ...
        'Global': '全局',
        'Character': '角色卡',
        'connection profile (apiId)': '连接配置（apiId）',
        'preset name': '预设名',
        ...
        'New file path (relative to skill root, e.g. references/notes.md):': '新文件路径（相对于技能根目录，例如 references/notes.md）：',
        'Create': '创建',
        'Cannot create: ${0}': '无法创建：${0}',
        'Created ${0}': '已创建 ${0}',
        'Create failed: ${0}': '创建失败：${0}',
        'Cannot delete SKILL.md from the editor — delete the whole skill from the manager.': '无法在编辑器中删除 SKILL.md——请在技能管理器中删除整个技能。',
        'Delete file "${0}"? This cannot be undone.': '确认删除文件「${0}」？此操作不可撤销。',
        'Deleted ${0}': '已删除 ${0}',
        // Inline editor — create-new-skill flow
        'Skill name (lowercase letters/digits/_/-):': '技能名（小写字母/数字/_/-）：',
        'Next': '下一步',
        'Invalid skill name: must match [a-z0-9_-]+': '技能名无效：必须匹配 [a-z0-9_-]+',
        'One-line description (when should this skill be used?):': '一句话描述（何时应当使用此技能？）：',
        'Description is required.': '必须填写描述。',
        'Install new skill into scope:': '将新技能安装到作用域：',
        'Created skill: ${0}': '已创建技能：${0}',
        // Embed import dialog (character / preset bundles)
        'No skills found in the embed payload.': '资源中未发现可导入的技能。',
        'New (install)': '新增（安装）',
        'Already installed (skip)': '已安装（跳过）',
        'Different (choose)': '不同（请选择）',
        'Invalid (will be ignored)': '无效（将忽略）',
        'Action': '操作',
        'Skills embedded in this asset will be installed into:': '此资源附带的技能将安装到：',
        'Skill embed preview failed: ${0}': '预览附带技能失败：${0}',
        'Popup API missing — cannot show import dialog.': '缺少弹窗 API——无法显示导入对话框。',
        'Install': '安装',
        'Skills imported: ${0} installed, ${1} skipped.': '技能导入完成：新装 ${0} 个，跳过 ${1} 个。',
        'Skill import failed: ${0}': '技能导入失败：${0}',
        // Embed export hook (preset bundling)
        'Bundled ${0} skill(s) with this preset.': '已将 ${0} 个技能打包到此预设。',
        'Failed to bundle skills with preset: ${0}': '将技能打包到预设失败：${0}',
        'Include preset-scope skills in this export?': '本次导出是否包含 Preset 作用域的技能？',
        'Include': '包含',
        ...
        'No bundled skills available.': '没有可用的分发技能。',
        'Name': '名称',
        'State': '状态',
        'Size': '大小',
        'Skills shipped with the server. Install any to add them under the Global scope.': '随服务器分发的技能。安装后会加入 Global 作用域。',
        'Install all bundled': '安装全部分发技能',
        'Failed to load bundled manifest: ${0}': '加载分发清单失败：${0}',
        'Failed to list installed skills: ${0}': '列出已安装技能失败：${0}',
        'Bundled install: ${0} installed, ${1} replaced.': '分发安装：新装 ${0} 个，替换 ${1} 个。',
        'Install all failed: ${0}': '一键安装失败：${0}',
        'Installed bundled skills (target: ${0}). ${1} new, ${2} replaced.': '已安装分发技能（目标：${0}）。新装 ${1} 个，替换 ${2} 个。',
    ...
    addLocaleData('zh-tw', {
        ...
        'Manage skills...': '管理技能…',
        'Skill manager failed: ${0}': '技能管理器開啟失敗：${0}',
        ...
        '(no tool calls — reasoning-only round)': '（無工具呼叫，純推理輪次）',
        'No main-agent rounds recorded.': '尚未記錄主代理輪次。',
        ...
        '${0} approved': '${0} 已批准',
        '${0} rejected': '${0} 已拒絕',
        'Commit ${0} lorebook decision(s)': '提交 ${0} 條世界書決定',
        'Clear ${0} rejected': '清除 ${0} 條已拒絕',
        ...
        'Skill Manager': '技能管理器',
        'Edit skill': '編輯技能',
        'Per-agent skill visibility. Use [+ inherit mode default] to combine.': '此 Agent 可見的技能。點擊 [+ 繼承模式預設] 與模式預設疊加。',
        'Per-node skill visibility. Use [+ inherit mode default] to combine.': '此節點可見的技能。點擊 [+ 繼承模式預設] 與模式預設疊加。',
        'Per-sub-agent skill visibility. Use [+ inherit mode default] to combine.': '此子代理可見的技能。點擊 [+ 繼承模式預設] 與模式預設疊加。',
        'Mode-level skills (baseline for every agent)': '模式級技能（所有 Agent 的基線）',
        'Mode-level skills (baseline for every node)': '模式級技能（所有節點的基線）',
        'Main agent skills': '主代理技能',
        'Planner skills': 'Planner 技能',
        'Skills visible to the loop agent.': 'Loop Agent 可見的技能。',
        'Skills visible to the main agent. + inherits mode default.': '主代理可見的技能。點擊 + 繼承模式預設。',
        'Skills visible to the planner. + inherits mode default.': 'Planner 可見的技能。點擊 + 繼承模式預設。',
        // Skill chips component
        '(inherit mode default)': '（繼承模式預設）',
        '+ inherit mode default': '+ 繼承模式預設',
        'Inherit mode default visible skills': '繼承模式預設的可見技能',
        'Inherit mode default visible skills. Click x to remove.': '繼承模式預設的可見技能。點擊 x 移除。',
        ...
        'Skill is not installed in your current data dir.': '目前資料目錄未安裝此技能。',
        'All available skills already chipped': '所有可用技能皆已新增',
        'Add a skill': '新增技能',
        'Add...': '新增……',
        'Add': '新增',
        // Skill manager panel — top-level shell
        'Installed': '已安裝',
        'Browse bundled': '瀏覽隨伺服器分發的技能',
        'Filter by scope:': '依作用域篩選：',
        'All scopes': '全部作用域',
        'Import bundled': '匯入隨伺服器分發的技能',
        ...
        'Move to...': '移動到……',
        'Rename': '重新命名',
        '(no skills in this scope)': '（此作用域下沒有技能）',
        'No skills installed. Use Import or Create to add some.': '目前沒有已安裝的技能。請使用「匯入」或「新建」新增。',
        'Failed to load skills: ${0}': '載入技能失敗：${0}',
        'Failed to render bundled browser: ${0}': '渲染分發列表失敗：${0}',
        // Skill manager actions — toasts / confirms / prompts
        'Bundled import: ${0} installed, ${1} skipped.': '從分發列表匯入：新裝 ${0} 個，略過 ${1} 個。',
        'Bundled import failed: ${0}': '從分發列表匯入失敗：${0}',
        'Failed to read file: ${0}': '讀取檔案失敗：${0}',
        'Unsupported file: ${0}': '不支援的檔案：${0}',
        'Import into scope': '匯入到作用域',
        'Enter the URL of a skill zip bundle': '請輸入技能 zip 包的連結',
        'Import': '匯入',
        'URL import: ${0} installed, ${1} skipped.': '從連結匯入：新裝 ${0} 個，略過 ${1} 個。',
        'URL import failed: ${0}': '從連結匯入失敗：${0}',
        'Failed to read skill: ${0}': '讀取技能失敗：${0}',
        'Delete skill "${0}" from ${1}? This cannot be undone.': '確認從 ${1} 刪除技能「${0}」？此操作無法復原。',
        'Deleted skill: ${0}': '已刪除技能：${0}',
        'Delete failed: ${0}': '刪除失敗：${0}',
        'Rename skill "${0}" to:': '將技能「${0}」重新命名為：',
        'A skill named "${0}" already exists in ${1}. Server will refuse the rename. Try a different name?': '${1} 中已存在名為「${0}」的技能，伺服器會拒絕此次重新命名。換一個名稱？',
        'Retry': '重試',
        'Renamed: ${0} -> ${1}': '已重新命名：${0} → ${1}',
        'Rename failed: ${0}': '重新命名失敗：${0}',
        'Move "${0}" to scope': '將「${0}」移動到作用域',
        'Skill already in that scope.': '技能已經在該作用域。',
        'A skill named "${0}" already exists in ${1}. Move will fail unless you delete the existing one first. Proceed anyway?': '${1} 中已存在名為「${0}」的技能，除非先刪除現有技能，否則移動會失敗。仍要繼續嗎？',
        'Proceed': '繼續',
        'Moved ${0}: ${1} -> ${2}': '已移動 ${0}：${1} → ${2}',
        'Move failed: ${0}': '移動失敗：${0}',
        'Preview failed: ${0}': '預覽失敗：${0}',
        'Skill "${0}" already exists in ${1} with different content. Replace it?': '${1} 中已存在名為「${0}」的技能且內容不同。是否取代？',
        'Replace': '取代',
        'Skip': '略過',
        ...
        'Global': '全域',
        'Character': '角色卡',
        'connection profile (apiId)': '連線設定（apiId）',
        'preset name': '預設名',
        ...
        'New file path (relative to skill root, e.g. references/notes.md):': '新檔案路徑（相對於技能根目錄，例如 references/notes.md）：',
        'Create': '建立',
        'Cannot create: ${0}': '無法建立：${0}',
        'Created ${0}': '已建立 ${0}',
        'Create failed: ${0}': '建立失敗：${0}',
        'Cannot delete SKILL.md from the editor — delete the whole skill from the manager.': '無法在編輯器中刪除 SKILL.md——請在技能管理器中刪除整個技能。',
        'Delete file "${0}"? This cannot be undone.': '確認刪除檔案「${0}」？此操作無法復原。',
        'Deleted ${0}': '已刪除 ${0}',
        // Inline editor — create-new-skill flow
        'Skill name (lowercase letters/digits/_/-):': '技能名（小寫字母/數字/_/-）：',
        'Next': '下一步',
        'Invalid skill name: must match [a-z0-9_-]+': '技能名無效：必須符合 [a-z0-9_-]+',
        'One-line description (when should this skill be used?):': '一句話描述（何時應當使用此技能？）：',
        'Description is required.': '必須填寫描述。',
        'Install new skill into scope:': '將新技能安裝到作用域：',
        'Created skill: ${0}': '已建立技能：${0}',
        // Embed import dialog (character / preset bundles)
        'No skills found in the embed payload.': '資源中未發現可匯入的技能。',
        'New (install)': '新增（安裝）',
        'Already installed (skip)': '已安裝（略過）',
        'Different (choose)': '不同（請選擇）',
        'Invalid (will be ignored)': '無效（將略過）',
        'Action': '操作',
        'Skills embedded in this asset will be installed into:': '此資源附帶的技能將安裝到：',
        'Skill embed preview failed: ${0}': '預覽附帶技能失敗：${0}',
        'Popup API missing — cannot show import dialog.': '缺少彈窗 API——無法顯示匯入對話框。',
        'Install': '安裝',
        'Skills imported: ${0} installed, ${1} skipped.': '技能匯入完成：新裝 ${0} 個，略過 ${1} 個。',
        'Skill import failed: ${0}': '技能匯入失敗：${0}',
        // Embed export hook (preset bundling)
        'Bundled ${0} skill(s) with this preset.': '已將 ${0} 個技能打包到此預設。',
        'Failed to bundle skills with preset: ${0}': '將技能打包到預設失敗：${0}',
        'Include preset-scope skills in this export?': '本次匯出是否包含 Preset 作用域的技能？',
        'Include': '包含',
        // Bundled browser tab (skill manager)
        'Differs': '內容不同',
        'Not installed': '未安裝',
        ...
        'No bundled skills available.': '沒有可用的分發技能。',
        'Name': '名稱',
        'State': '狀態',
        'Size': '大小',
        'Skills shipped with the server. Install any to add them under the Global scope.': '隨伺服器分發的技能。安裝後會加入 Global 作用域。',
        'Install all bundled': '安裝全部分發技能',
        'Failed to load bundled manifest: ${0}': '載入分發清單失敗：${0}',
        'Failed to list installed skills: ${0}': '列出已安裝技能失敗：${0}',
        'Bundled install: ${0} installed, ${1} replaced.': '分發安裝：新裝 ${0} 個，取代 ${1} 個。',
        'Install all failed: ${0}': '一鍵安裝失敗：${0}',
        'Installed bundled skills (target: ${0}). ${1} new, ${2} replaced.': '已安裝分發技能（目標：${0}）。新裝 ${1} 個，取代 ${2} 個。',
