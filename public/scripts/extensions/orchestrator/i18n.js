...
export function registerLocaleData() {
    ...
    _addLocaleData('zh-cn', {
        ...
        'At Chat Depth': '聊天深度',
        'Injection depth (At Chat Depth only)': '编排指导注入深度（仅“聊天深度”位置生效）',
        'Injection role (At Chat Depth only)': '编排指导注入角色（仅“聊天深度”位置生效）',
    ...
    _addLocaleData('zh-tw', {
        ...
        'At Chat Depth': '聊天深度',
        'Injection depth (At Chat Depth only)': '編排指導注入深度（僅「聊天深度」位置生效）',
        'Injection role (At Chat Depth only)': '編排指導注入角色（僅「聊天深度」位置生效）',
