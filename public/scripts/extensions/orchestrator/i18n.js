...
export function registerLocaleData() {
    addLocaleData('zh-cn', {
        ...
        'LLM node API preset (Connection profile)': '单 Agent API 预设（连接配置）',
        'LLM node preset (params + prompt)': '单 Agent 提示词预设（参数+提示词）',
        ...
        'AI build API preset (Connection profile)': 'AI 编排生成 API 预设（连接配置）',
        'AI build preset (params + prompt)': 'AI 编排生成提示词预设（参数+提示词）',
        'AI build system prompt': 'AI 编排生成系统提示词',
        ...
        'Editing:': '当前编辑：',
        'Global profile': '全局配置',
        'AI build goal (optional)': 'AI 编排生成目标（可选）',
        ...
        'AI profile generation failed.': 'AI 编排生成失败。',
        'AI profile generation cancelled.': 'AI 编排生成已由用户终止。',
        ...
        '(missing)': '（缺失）',
        'AI build did not call finalize explicitly. Parsed output was used anyway.': 'AI 编排生成未显式调用 finalize。已直接采用解析结果。',
        'AI build did not call finalize explicitly.': 'AI 编排生成未显式调用 finalize。',
        'AI build must return multiple tool calls in one response.': 'AI 编排生成必须在一次响应里返回多个工具调用。',
        'AI profile generation failed: ${0}': 'AI 编排生成失败：${0}',
        'Generating orchestration profile for ${0}...': '正在为 ${0} 生成编排配置...',
        'Function output is invalid.': '函数输出无效。',
        'AI build did not provide any stage tool calls.': 'AI 编排生成未提供任何阶段工具调用。',
    ...
    addLocaleData('zh-tw', {
        ...
        'LLM node API preset (Connection profile)': '單 Agent API 預設（連線設定）',
        'LLM node preset (params + prompt)': '單 Agent 提示詞預設（參數+提示詞）',
        ...
        'AI build API preset (Connection profile)': 'AI 編排生成 API 預設（連線設定）',
        'AI build preset (params + prompt)': 'AI 編排生成提示詞預設（參數+提示詞）',
        'AI build system prompt': 'AI 編排生成系統提示詞',
        ...
        'Editing:': '目前編輯：',
        'Global profile': '全域設定',
        'AI build goal (optional)': 'AI 編排生成目標（可選）',
        ...
        'AI Build Profile': 'AI 一鍵編排',
        'AI Quick Build': 'AI 一鍵編排',
        ...
        'AI profile generation failed.': 'AI 編排生成失敗。',
        'AI profile generation cancelled.': 'AI 編排生成已由使用者終止。',
        ...
        '(missing)': '（缺失）',
        'AI build did not call finalize explicitly. Parsed output was used anyway.': 'AI 編排生成未明確呼叫 finalize。已直接採用解析結果。',
        'AI build did not call finalize explicitly.': 'AI 編排生成未明確呼叫 finalize。',
        'AI build must return multiple tool calls in one response.': 'AI 編排生成必須在一次回應中返回多個工具呼叫。',
        'AI profile generation failed: ${0}': 'AI 編排生成失敗：${0}',
        'Generating orchestration profile for ${0}...': '正在為 ${0} 生成編排設定...',
        'Function output is invalid.': '函式輸出無效。',
        'AI build did not provide any stage tool calls.': 'AI 編排生成未提供任何階段工具呼叫。',
