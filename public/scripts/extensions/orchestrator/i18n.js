...
export function registerLocaleData() {
    addLocaleData('zh-cn', {
        ...
        'LLM node API preset (Connection profile)': 'LLM 节点 API 预设（连接配置）',
        'LLM node preset (params + prompt)': 'LLM 节点提示词预设（参数+提示词）',
        ...
        'AI build API preset (Connection profile)': 'AI 生成 API 预设（连接配置）',
        'AI build preset (params + prompt)': 'AI 生成提示词预设（参数+提示词）',
    ...
    addLocaleData('zh-tw', {
        ...
        'LLM node API preset (Connection profile)': 'LLM 節點 API 預設（連線設定）',
        'LLM node preset (params + prompt)': 'LLM 節點提示詞預設（參數+提示詞）',
        ...
        'AI build API preset (Connection profile)': 'AI 生成 API 預設（連線設定）',
        'AI build preset (params + prompt)': 'AI 生成提示詞預設（參數+提示詞）',
