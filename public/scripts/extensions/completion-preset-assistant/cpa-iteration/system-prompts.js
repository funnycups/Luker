...
export function buildOrchestratorOptimizeModeBlock() {
    return [
        ...
        '   with a one-line pointer like `参考 skill <skill-name>`. Three tool',
        '   calls in one round: `skill_create` (verbatim body), then',
        '   `preset_str_delete_in_prompt` to remove the slice, then',
        '   `preset_str_insert_in_prompt` to splice in the pointer. The user',
        '   reviews each as a normal pending edit.',
        '',
