...
describe('MacroParser', () => {
    ...
    describe('General Macro', () => {
        // {{user}}
        test('should parse a simple macro', async () => {
            const input = '{{user}}';
        ...
        // {{  user  }}
        test('should generally handle whitespaces', async () => {
            const input = '{{  user  }}';
            const macroCst = await runParser(input);
    ...
    describe('Arguments Handling', () => {
        // {{getvar::myvar}}
        test('should parse macros with double-colon argument', async () => {
        ...
        // {{roll:3d20}}
        test('should parse macros with single colon argument', async () => {
        ...
        // {{setvar::myvar::value}}
        test('should parse macros with multiple double-colon arguments', async () => {
        ...
        // {{something::  spaced  }}
        test('should strip spaces around arguments', async () => {
        ...
        // {{something::}}
        test('should parse double-colon with an empty argument value', async () => {
    ...
    describe('Legacy Macros', () => {
        // {{roll 1d5}}
        test('should parse legacy roll macro with whitespace separator', async () => {
        ...
        // {{roll:2d20}}
        test('should parse legacy roll macro with explicit colon separator', async () => {
        ...
        // {{roll 20}}
        test('should parse legacy roll macro with numeric argument', async () => {
            const input = '{{roll 20}}';
            const macroCst = await runParser(input, {
                flattenKeys: ['arguments.argument'],
            });
        ...
        // {{reverse:something}}
        test('should parse reverse legacy macro with colon argument', async () => {
        ...
        test('should parse legacy comment macro', async () => {
        ...
        test('should parse legacy datetime format macro', async () => {
        ...
        // {{banned "abannedword"}}
        test('should parse legacy banned macro with quoted argument', async () => {
        ...
        // {{banned ""}}
        test('should parse legacy macro with empty quoted argument', async () => {
            const input = '{{banned ""}}';
            const macroCst = await runParser(input, {
                flattenKeys: ['arguments.argument'],
            });
        ...
        // {{setvar::myvar::}}
        test('should allow legacy setvar with empty value argument', async () => {
    ...
    describe('Comment Macros', () => {
        // {{//comment}}
        test('should parse comment macro without whitespace', async () => {
            const input = '{{//comment}}';
            const macroCst = await runParser(input, {
                flattenKeys: ['arguments.argument'],
            });
        ...
        // {{// comment}}
        test('should parse comment macro with whitespace', async () => {
            const input = '{{// comment}}';
            const macroCst = await runParser(input, {
                flattenKeys: ['arguments.argument'],
            });
        ...
        // {{//!@#$%^&*()_+}}
        test('should parse comment macro with special characters', async () => {
            const input = '{{//!@#$%^&*()_+}}';
            const macroCst = await runParser(input, {
                flattenKeys: ['arguments.argument'],
            });
        ...
        // {{//!@flags}}
        test('should parse comment macro starting with flags', async () => {
            const input = '{{//!@flags}}';
            const macroCst = await runParser(input, {
                flattenKeys: ['arguments.argument'],
            });
        ...
        // }}
        test('should parse multiline comments', async () => {
...
This is the second line
    ...
    describe('Nested Macros', () => {
        // {{outer::word {{inner}}}}
        test('should parse nested macros inside arguments', async () => {
    ...
    describe('Macro Flags', () => {
        // {{!user}}
        test('should parse macro with single flag', async () => {
            const input = '{{!user}}';
            const macroCst = await runParser(input);
        ...
        // {{?delayed}}
        test('should parse macro with delayed flag', async () => {
            const input = '{{?delayed}}';
            const macroCst = await runParser(input);
        ...
        // {{/closing}}
        test('should parse macro with closing block flag', async () => {
            const input = '{{/closing}}';
            const macroCst = await runParser(input);
        ...
        // {{>filtered}}
        test('should parse macro with filter flag', async () => {
        ...
        // {{!?user}}
        test('should parse macro with multiple flags', async () => {
            const input = '{{!?user}}';
            const macroCst = await runParser(input);
        ...
        // {{ ! > macro }}
        test('should parse macro with flags and whitespace', async () => {
            const input = '{{ ! > macro }}';
            const macroCst = await runParser(input);
        ...
        // {{#legacy}}
        test('should parse macro with legacy hash flag', async () => {
            const input = '{{#legacy}}';
            const macroCst = await runParser(input);
        ...
        // {{!setvar::value::test}}
        test('should parse macro with flag and arguments', async () => {
    ...
    describe('Variable Shorthand Syntax', () => {
        ...
        test('should parse local variable shorthand', async () => {
            const input = '{{.myvar}}';
            const macroCst = await runParser(input);
        ...
        test('should parse global variable shorthand', async () => {
            const input = '{{$myvar}}';
            const macroCst = await runParser(input);
        ...
        test('should parse variable with hyphen in name', async () => {
            const input = '{{.my-var}}';
            const macroCst = await runParser(input);
        ...
        test('should parse variable set shorthand', async () => {
        ...
        test('should parse variable increment shorthand', async () => {
            const input = '{{.counter++}}';
            const macroCst = await runParser(input);
        ...
        test('should parse global variable decrement shorthand', async () => {
            const input = '{{$counter--}}';
            const macroCst = await runParser(input);
        ...
        test('should parse variable add shorthand', async () => {
            const input = '{{.myvar += 5}}';
            const macroCst = await runParser(input);
        ...
        test('should parse nested macro in variable value', async () => {
        ...
        test('should parse variable shorthand with whitespace', async () => {
 ...
 * @param {string[]} [options.flattenKeys=[]] Optional array of dot-separated keys to flatten
 * @param {string[]} [options.ignoreKeys=[]] Optional array of dot-separated keys to ignore
 * @returns {Promise<{cst: TestableCstNode, errors: TestableRecognitionException[]}>}
 */
