...
test.describe('iteration-library exposure', () => {
    test('getContext().iterationLibrary has expected keys; iterationStudio is gone', async ({ page }) => {
        ...
        expect(exposed.keys).toEqual(expect.arrayContaining(['applyEdits', 'inverseEdit', 'registerOp', 'BUILT_IN_OPS', 'render', 'runner', 'storage', 'textDiff', 'zoomOverlay', 'showConflictResolution']));
